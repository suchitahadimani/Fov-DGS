...
def training(dataset, opt, pipe, testing_iterations, saving_iterations):
    ...
    #the gaussians are pulled from the guassian model and deform model defined in the scene
    tb_writer = prepare_output_and_logger(dataset)

    #Not sure if this will run, but can create Gaussian class.
...
# PRINTS ALL THE OUTPUT THAT I SEE IN OUTPUT FILE, CAN USE THIS FOR LOGGING TOO
...
# this is where is actually starts running!!
